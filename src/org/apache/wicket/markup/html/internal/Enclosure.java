...
public class Enclosure extends WebMarkupContainer implements IComponentResolver
{
	 ...
	 * @param childId
	 */
	public Enclosure(final String id, final CharSequence childId, final CharSequence renderBodyOnly)
	{
		super(id);
		...
		if("true".equals(renderBodyOnly)) {
			setRenderBodyOnly(true);
		}
//		System.out.println("FLAG:"+renderBodyOnly);
	}
