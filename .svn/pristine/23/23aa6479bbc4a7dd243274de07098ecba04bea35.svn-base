...
public class WicketMessageResolver implements IComponentResolver
{
		...
		final ComponentTag tag)
	{
		if (tag instanceof WicketTag)
		{
			...
			if (wtag.isMessageTag())
			{
				...
				String labelFor = wtag.getAttributes().getString("labelFor");
				...
				MessageContainer label = new MessageContainer(id, messageKey, labelFor);
	...
	private static class MessageContainer extends MarkupContainer implements IComponentResolver
	{
		 ...
		 * @param labelFor 
		 */
		public MessageContainer(final String id, final String messageKey, String labelFor)
		{
