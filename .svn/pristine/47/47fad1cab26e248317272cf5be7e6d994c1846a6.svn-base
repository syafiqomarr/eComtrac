 ...
 */
public class SSMPagingNavigator extends Panel
{
	 ...
	 */
	public SSMPagingNavigator(final String id, final IPageable pageable)
	{
	...
	private final class TitleAppender extends Behavior
	{
		...
		{
			tag.put("title", SSMPagingNavigator.this.getString(resourceKey));
		}
	}
}